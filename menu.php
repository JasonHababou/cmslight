...
error_reporting(E_ALL ^ E_DEPRECATED);
	...
	if (isset($_SESSION['admin_mode'])) {
		echo "<a class='root' target='frameContents' href='show_root.php'>";
		echo "RACINE";
		echo "</a>";
	}
	...
	if ($chapter) do {
		...
		echo "<a class='chapter' target='frameContents' href='show_chapter.php?chapter=$chapter_id'>";
		echo $chapter->title();
		echo "</a>";
		...
		if ($paragraph) do {
			...
			echo "<a class='paragraph' target='frameContents' href='show_paragraph.php?chapter=$chapter_id&paragraph=$paragraph_id'>";
