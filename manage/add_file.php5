...
<?php
	...
	echo build_path(node::get_node_by_id($p_chapter), $parent)."ajouter un fichier";
	echo '</div>';
	...
	if (isset($_FILES[file])) {
		...
		if (!strlen($filename)) {
			...
			sql_query("INSERT INTO files(path, author, comment) VALUES('$filename','$p_author','$p_comment')");
...
<form method="post" enctype="multipart/form-data" action="#">
	...
	<table>
		...
		<tr><td width="100">
			...
			<input type="text" name="author" value="<?php echo $p_author; ?>"/>
		</td></tr>
		<tr><td>
			Commentaire :
		</td><td>
			<input type="text" name="comment" value="<?php echo $p_comment; ?>" />
		</td></tr>
		<tr><td colspan="2" align="right">
			<br/>
