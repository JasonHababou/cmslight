	...
	if ($paragraph) do {
		...
		echo "<div>";
			...
			if (isset($_SESSION['admin_mode'])) {
				echo "<a class='button' title='' href='manage/move_down.php5?id=$paragraph_id'>&darr;</a>";
				echo "<a class='button' title='' href='manage/move_up.php5?id=$paragraph_id'>&uarr;</a>";
				echo "<a class='button' title='Editer' href='manage/edit_section.php5?chapter=$chapter_id&id=$paragraph_id'>E</a>";
				echo "<a class='button' title='Ajouter un fichier' href='manage/add_file.php5?chapter=$chapter_id&id=$paragraph_id'>A</a>";
				echo "<a class='button' title='Supprimer' href='manage/remove_node.php5?chapter=$chapter_id&id=$paragraph_id'>X</a>";
			}
		echo "</div><br/>";
